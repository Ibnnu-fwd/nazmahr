...
class PermitLeaveController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            return datatables()
                ->of($this->permitLeave->getAll()->where('user_id', auth()->user()->id))
                ...
                ->addColumn('attachment', function ($data) {
                    return view('user.permit_leave.column.attachment', compact('data'));
                })
                ...
                ->addColumn('action', function ($data) {
                    return view('user.permit_leave.column.action', compact('data'));
                })
                ->addIndexColumn()
                ->make(true);
        }

        return view('user.permit_leave.index');
    }

    public function create()
    {
        return view('user.permit_leave.create', [
    ...
    {
        return view('user.permit_leave.edit', [
